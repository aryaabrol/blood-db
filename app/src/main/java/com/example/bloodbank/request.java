...
public class request extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    private EditText name,phone,city,message;
    Spinner bloodGroup;
        ...
        register.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(TextUtils.isEmpty(name1)) Toast.makeText(getApplicationContext(),"Please enter name",Toast.LENGTH_SHORT).show();
                    ...
                    AddData(name1,phone1,city1,bloodGroup1,message1);
                }
            }
        });
    }

    private void AddData(final String name1, final String phone1, final String city1, final String bloodGroup1,final String message1) {
        final DatabaseReference ref= FirebaseDatabase.getInstance().getReference();
        ref.addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if(!(dataSnapshot.child("Requests").child(phone1).exists())){
                    ...
                    ref.child("Requests").child(phone1).updateChildren(hashMap)
